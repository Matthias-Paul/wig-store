...
export function OrderStatusSelect({
  ...
  return (
    <select
      ...
      className="text-xs border border-gray-200 rounded-md px-2 py-1.5 outline-none focus:ring-2 focus:ring-brand focus:border-brand bg-gray-300 cursor-pointer disabled:opacity-50"
    >
